...
TOKEN = os.getenv('8304268332:AAHCsXJo8djvW6Ily_Bcu7X2dLa6IpI1NYg') # Prefer .env
if not TOKEN or TOKEN == "8304268332:AAHCsXJo8djvW6Ily_Bcu7X2dLa6IpI1NYg": # Check if token is missing or placeholder
    # !!! Replace with your actual bot token if not using .env !!!
    TOKEN = "8304268332:AAHCsXJo8djvW6Ily_Bcu7X2dLa6IpI1NYg" # FALLBACK - Highly recommended to use .env
...
ADMIN_ID = int(os.getenv('ADMIN_ID', 6565112453)) # Default to 0 (disabled) if not set or invalid
# Check and warn if ADMIN_ID is 0 but commands are expected
if ADMIN_ID == 6565112453:
