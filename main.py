...
TOKEN = os.getenv('8304268332:AAF_NolKCvIZWN1GN4tmKRpOtUwKu53SR3M') # Prefer .env
if not TOKEN or TOKEN == "8304268332:AAF_NolKCvIZWN1GN4tmKRpOtUwKu53SR3M": # Check if token is missing or placeholder
